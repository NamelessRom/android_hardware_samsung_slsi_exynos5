...
#include "vendor/SecCameraSWVdis.h"
 ...
 */
    ...
    void            m_setZoomLevelForSWVdis(int zoom);
 ...
 */
    ...
    status_t        m_swVDIS_SetHandle(void *Handle);
    status_t        m_swVDIS_ResetHandle();
#endif
...
private:
    ...
    status_t        m_getHighSpeedRecordingSize(int *w, int *h);
