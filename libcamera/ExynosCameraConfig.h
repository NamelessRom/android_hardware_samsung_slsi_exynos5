...
enum fimc_is_video_dev_num {
    ...
    FIMC_IS_VIDEO_SS1_NUM               = 102,
    FIMC_IS_VIDEO_SS2_NUM               = 103,
    FIMC_IS_VIDEO_SS3_NUM               = 104,
    FIMC_IS_VIDEO_3A0_NUM               = 110,
    FIMC_IS_VIDEO_3A0C_NUM              = 111,
    FIMC_IS_VIDEO_3A0P_NUM              = 112,
    FIMC_IS_VIDEO_3A1_NUM               = 120,
    FIMC_IS_VIDEO_3A1C_NUM              = 121,
    FIMC_IS_VIDEO_3A1P_NUM              = 122,
    FIMC_IS_VIDEO_ISP_NUM               = 130,
    FIMC_IS_VIDEO_SCC_NUM               = 151,
    FIMC_IS_VIDEO_SCP_NUM               = 152,
    FIMC_IS_VIDEO_VDC_NUM               = 140,
    FIMC_IS_VIDEO_VDO_NUM               = 141,
    FIMC_IS_VIDEO_FD_NUM                = 150,
