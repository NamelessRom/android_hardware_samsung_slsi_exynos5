...
struct ExynosSensorInfo *createSensorInfo(int camId)
{
    ...
    case SENSOR_NAME_IMX240:
        sensorInfo = new ExynosSensorIMX240();
        break;
...
ExynosSensorIMX240::ExynosSensorIMX240()
{
    maxPreviewW = 5312;
    maxPreviewH = 2988;
    maxPictureW = 5312;
    ...
    apertureNum = 185;
    apertureDen = 100;
    horizontalViewAngle = 51.2f; //TODO
    verticalViewAngle = 41.0f; //http://gregstoll.dyndns.org/~gregstoll/floattohex/
    focalLengthIn35mmLength = 31;
    ...
    maxExposureCompensation = 4;
    exposureCompensationStep = 0.5f;
    //maxExposureTime = 0.0f;
    //minExposureTime = 0.0f;
    //sensorMinExposureTime = 32000LL;
    //sensorMaxExposureTime = 500000000LL;
    //sensorMargin0 = 16;
    //sensorMargin1 = 12;
    maxNumDetectedFaces = 16;
    maxNumFocusAreas = 2;
    ...
    antiBandingList =
          ANTIBANDING_AUTO
        | ANTIBANDING_50HZ //in blob only auto is offered :-O
        | ANTIBANDING_60HZ
        | ANTIBANDING_OFF
        ;
    ...
    //videoSizeLutHighSpeedMax = sizeof(VIDEO_SIZE_LUT_HIGHSPEED_IMX240) / (sizeof(int) * SIZE_OF_LUT);
    //videoSizeLutHighSpeed = VIDEO_SIZE_LUT_HIGHSPEED_IMX240;
    sizeTableSupport      = false;
