...
// online XOR calculator:   http://xor.pw/?

//PROPERTY_KEY2 = "ro.nameless.version"
const unsigned int PROPERTY_KEY2[50] = {0x8d, 0x90, 0xd1, 0x91, 0x9e, 0x92, 0x9a, 0x93, 0x9a, 0x8c, 0x8c, 0xd1, 0x89, 0x9a, 0x8d, 0x8c, 0x96, 0x90, 0x91, 0x00};

//NAMELESSVERSION ="3.0-zerofltexx-20160715"
const unsigned int NAMELESSVERSION[50] = {0xcc, 0xd1, 0xcf, 0xd2, 0x85, 0x9a, 0x8d, 0x90, 0x99, 0x93, 0x8b, 0x9a, 0x87, 0x87, 0xd2, 0xcd, 0xcf, 0xce, 0xc9, 0xcf, 0xc8, 0xce, 0xca, 0x00};

const size_t NUM_HW_WINDOWS = 7;
const size_t NUM_RGB_HW_WINDOWS = 3;
const size_t NUM_INT_HW_WINDOWS = 2;
const size_t NUM_OTHER_HW_WINDOWS = NUM_HW_WINDOWS - NUM_RGB_HW_WINDOWS;
...
struct exynos5_gsc_map_t {
    enum {
        ...
        GSC_LOCAL,
        GSC_DECON_INT,
        GSC_DECON_INT_RGB, //internal decon MPP for rgb composition
        GSC_DECON_EXT,
    } mode;
    int idx;
};
...
struct exynos5_hwc_post_data_t {
    ...
    size_t              fb_window;
    enum decon_idma_type    decon_dma_type[NUM_HW_WINDOWS];
    int                 numRgbOvly;
    int                 numIntOvly;
};
...
struct exynos5_hwc_composer_device_1_t {
    ...
    //ExynosDisplayResourceManagerModule *displayResMgrModule;
    ...
    unsigned int            legitimate_installation;
